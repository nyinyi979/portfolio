...
export default function Works() {
  ...
  const works = React.useRef([
    {
      ...
      description:
        "A contract project about tarot's and the creator of the page with various type of subscriptions!",
    },

    {
      ...
      description:
        "Open source project alternative to shadcn/ui for react native! CLI",
    },
...

    {
      ...
      description:
        "Open source project alternative to shadcn/ui for react native!",
    },
    ...
    },
    {
      ...
      description:
        "Blog app where you can post, edit, delete, like, comment and share the posts.",
    },
  ...
  return (
    <>
      ...
      <motion.div id="works" className="p-5">
        <motion.button
  ...
  return (
    ...
    >
      ...
      >
        <div className="w-full h-fit rounded-md mx-auto">
          <Image
            ...
            alt={img_url.src}
            src={img_url}
            className="bg-cover duration-300 rounded-md scale-95 hover:scale-[.96]"
          />
        </div>
        <motion.div
          initial={{ opacity: 0 }}
      ...
      <div className="flex flex-row gap-2 mb-2 mt-5 w-fit">
        <Link
          target="_blank"
          className="w-40 h-fit mx-auto inline-block p-1 py-2 font-semibold text-center text-white bg-gradient-to-r from-cyan-400 to-cyan-500 hover:shadow-md hover:shadow-cyan-600 duration-300"
          href={liveLink}
        >
          See it Live!
        </Link>
        <Link
          target="_blank"
          className="w-40 h-fit mx-auto inline-block p-1 py-2 font-semibold text-center text-white bg-gradient-to-r from-red-500 to-red-600 hover:shadow-md hover:shadow-red-600 duration-300"
          href={githubLink}
        >
          See it on Github!
        </Link>
